...
<div class="news-card rounded-2xl p-5 shadow-sm backdrop-blur-sm" data-scroll-reveal="fade-left">
  ...
  <ul class="mt-2 list-inside list-disc space-y-1 text-neutral-900 dark:text-neutral-100">
    <li>The <a href="https://www.sfi.org.bm/">Simons Foundation International</a> awarded a Simons Empire Faculty Fellowship that will support the Lange Lab over the next 3 years!</li>
  </ul>
</div>
</div>
